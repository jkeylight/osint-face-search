"""
TikTok Public Video/Image Scraper
"""
import asyncio
...
class TikTokScraper(BaseScraper):
    """TikTok public content scraper"""
    
    def __init__(self):
        super().__init__()
        self.engine_name = "tiktok"
        self.cooldown = 5.0
        self._browser = None
        self._context = None
    ...
    async def search(self, image_path: str) -> List[SearchResult]:
        ...
        try:
            ...
            await page.goto("https://www.tiktok.com/search?q=", wait_until="networkidle")
            await self._random_delay(3, 5)
            
            results = await self._extract_videos(page)
    ...
    async def _extract_videos(self, page) -> List[SearchResult]:
        results = []
        try:
            items = await page.query_selector_all('[data-e2e="search_top-item"], .tiktok-x6y88p-DivItemContainer')
                    ...
                    if link:
                        ...
                        if href and '/video/' in href:
                            ...
                            results.append(SearchResult(
                                url=href, source_url="https://tiktok.com",
                                title="TikTok video", engine="tiktok",
