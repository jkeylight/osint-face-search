# AETHER-STREAM scaffold

A new additive monorepo scaffold now lives in [`aether-stream/`](aether-stream/). It keeps the existing OSINT Face Search application intact while providing the requested Rust + Tauri + Svelte 5 foundation for AETHER-STREAM.
